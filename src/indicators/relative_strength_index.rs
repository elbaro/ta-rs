...
use crate::indicators::RelativeMovingAverage as Rma;
...
pub struct RelativeStrengthIndex {
    period: usize,
    up_ema_indicator: Rma,
    down_ema_indicator: Rma,
    prev_val: f64,
    is_new: bool,
}
...
impl RelativeStrengthIndex {
    pub fn new(period: usize) -> Result<Self> {
        Ok(Self {
            period,
            up_ema_indicator: Rma::new(period)?,
            down_ema_indicator: Rma::new(period)?,
            prev_val: 0.0,
            is_new: true,
        })
    }
